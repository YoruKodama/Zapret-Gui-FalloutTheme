...
1. **Скачайте и распакуйте все файлы**
2. **Запустите:** `START_GUI.bat`
3. **Выберите стратегию:** `general.bat`
4. **Нажмите:** "ЗАПУСТИТЬ"
...
- **[GUI_README.md](GUI_README.md)** - 🎨 **Описание визуального интерфейса** (скриншоты, дизайн, возможности)
- [QUICKSTART.md](QUICKSTART.md) - быстрая инструкция
- [MATRIX_GUI_README.md](MATRIX_GUI_README.md) - подробное описание
