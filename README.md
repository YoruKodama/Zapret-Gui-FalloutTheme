...
**Самый простой способ - используйте готовый .exe файл:**

1. Скачайте `ZapretMatrixGUI.exe` из папки `dist/`
...
- ✅ **Размер:** ~22 MB (все библиотеки внутри)
...
Хотите пересобрать .exe самостоятельно?
